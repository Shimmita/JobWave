...
fun homeListData(): MutableList<HomeGridItem> {
    return mutableListOf(
        ...
        HomeGridItem(image = R.drawable.django, title = "Python Django Dev"),
